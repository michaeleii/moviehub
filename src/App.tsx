...
function WatchedMoviesList({ watched }: { watched: WatchedMovieItem[] }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
...
function WatchedMovie({ movie }: { movie: WatchedMovieItem }) {
  return (
    <li key={movie.imdbID}>
...
function WatchedSummary({ watched }: { watched: WatchedMovieItem[] }) {
